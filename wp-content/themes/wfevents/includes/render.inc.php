...
?>
    <li class="<?= implode(' ', $classes) ?>"><a class="page-link" href="<?= ($href) ?>"><?= ($previous) ?></a></li>
<?php
        /**
...
?>
    <li class="page-item"><a class="page-link" data-pagenumber="<?= ($current + $x - $leading) ?>" href="<?= ($href) ?>"><?= ($current + $x - $leading) ?></a></li>
<?php
            }

            // print current page
?>
    <li class="page-item active"><a class="page-link" data-pagenumber="<?= ($current) ?>" href="#"><?= ($current) ?></a></li>
<?php
...
?>
    <li class="page-item"><a class="page-link" data-pagenumber="<?= ($current + $x + 1) ?>" href="<?= ($href) ?>"><?= ($current + $x + 1) ?></a></li>
<?php
            }
        }
...
?>
    <li class="<?= implode(' ', $classes) ?>"><a class="page-link" href="<?= ($href) ?>"><?= ($next) ?></a></li>
</ul>
<?php
    }
